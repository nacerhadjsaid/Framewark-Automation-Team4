...
//        sleepFor(5);
        ...
        driver.get("https://youtu.be/Oi9LBSYZgEk"); // open your browser at youtube video.

        WebElement video = driver.findElement(By.id("movie_player"));// use the id of the video to find it
