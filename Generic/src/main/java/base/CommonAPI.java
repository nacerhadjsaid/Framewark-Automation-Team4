...
public class CommonAPI {
    ...
    public String browserstack_username = "mahmudurrahman4";
    public String browserstack_accesskey = "hjgzxEznprvmJfdGbCwt";
    ...
    public void javaScriptExecutor(String JavascriptExecutor){
